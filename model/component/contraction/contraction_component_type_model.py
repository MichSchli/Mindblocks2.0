class ContractionComponentTypeModel:
    ...
    def execute(self, in_sockets, value):
        ...
        c1_output = value.source_component.component_type.execute(in_sockets, value.source_component.value)

        c2_input = value.distribute_to_target(c1_output, in_sockets[c1_in_sockets:])
        c2_output = value.target_component.component_type.execute(c2_input, value.target_component.value)
