...
class TestPointerNetwork(unittest.TestCase):
    ...
    def testReverseSequenceTaskWithCombinedVocab(self):
        ...
        block_filepath = self.setup_holder.filepath_handler.get_test_block_path(filename)
        data_filepath = self.setup_holder.filepath_handler.get_test_data_path("nmt/reverse_sequence_plus_vocab/")
        embedding_filepath = self.setup_holder.filepath_handler.get_test_data_path("embeddings/")
    ...
    def testReverseSequenceTaskWithCombinedVocabAndUnks(self):
        filename = "full_ml_tests/pointer_network/pointer_plus_decoder_two_vocabs.xml"
